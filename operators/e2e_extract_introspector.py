...
import pandas as pd
"""
Note to self: started editin, i.e. combining extractor and introspector, the main problem is to replicate the batched structure. I will continue this but 
there are time sensitive experiments, so putting this on hold, for now.
"""
class E2EIntrospector(Operator):
    def __init__(self,config):
        #Obtain the necessary configs from the main config
