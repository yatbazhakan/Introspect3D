...
try:
    ...
    from mmseg.apis import inference_model as inference_segmenter
except:
...
if __name__ == '__main__':
    ...
    with tqdm(total=7481) as pbar:
        for i in range(7481):
            ...
            segmentation_result = inference_segmenter(seg_model, rgb_image)
            # print(segmentation_result)
            # exit()7
            # print(segmentation_result.pred_sem_seg.shape)
            ...
            cv2.imshow("Overlayed",overlayed_image)
            cv2.waitKey(0)
