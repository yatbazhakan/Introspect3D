...
import os
kitti_root_path = r"C:\Users\Yatbaz_H\OneDrive - University of Warwick\Documents\MATLAB\perFramePaper"
converter = DatasetConverter(root_dir=kitti_root_path,output_dir=os.path.join(kitti_root_path,'coco'))
